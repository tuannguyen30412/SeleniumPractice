...
public class JSExecutorPractice {
    ...
    public static void javaScriptExeMethod() {
        ...
        WebElement loginButton = driver.findElement(By.cssSelector(".ZFr60d.CeoRYc"));
        JavascriptExecutor js = (JavascriptExecutor) driver;

        js.executeScript("document.getElementById('identifierId').value='tuannguyen3412@gmail.com';");
